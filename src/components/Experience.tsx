    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {t.experience.map((exp, i) => (
          <div key={i} className="bg-slate-50 dark:bg-zinc-900/40 border border-slate-200 dark:border-zinc-800/80 rounded-[2rem] p-6 transition duration-300 hover:-translate-y-1 hover:bg-white dark:hover:bg-zinc-800 hover:border-slate-300 dark:hover:border-zinc-700 hover:shadow-[0_10px_20px_rgba(0,0,0,0.05)] hover:dark:shadow-[0_0_20px_rgba(99,102,241,0.1)]">
