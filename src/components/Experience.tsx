  ...
  return (
    ...
    >
      <motion.div variants={staggerItem} className="flex flex-col gap-3">
        <div className="text-caption uppercase text-fluo">{ui.experienceTitle}</div>
          ...
          return (
            ...
            >
              <button
                ...
                onClick={() => toggle(i)}
                aria-expanded={open}
                className={`exp-toggle group w-full flex flex-col sm:flex-row gap-4 sm:gap-8 py-8 text-left cursor-pointer ${i === 0 ? "pt-0" : ""}`}
              >
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                  ...
                  <span className="exp-pill mt-2 inline-flex items-center gap-2 text-caption uppercase border border-[#aaaaaa] group-hover:border-black rounded-full px-4 py-2 whitespace-nowrap transition-colors">
              ...
              <motion.div
                ...
                className="exp-panel overflow-hidden"
              >
