...
export function Hero() {
  ...
  return (
    <motion.section 
      ...
      className="col-span-1 md:col-span-8 bg-white dark:bg-[#18181b] border border-slate-200 dark:border-zinc-800 rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-center gap-4 shadow-xl dark:shadow-2xl relative overflow-hidden transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_0_40px_rgba(99,102,241,0.15)] hover:border-slate-300 dark:hover:border-zinc-700/80"
    >
      <div className="absolute top-0 right-0 p-8 text-6xl md:text-8xl opacity-[0.03] font-black text-slate-900 dark:text-white pointer-events-none tracking-tighter">EXPERT</div>
